      ...
      <div className="colorlib-narrow-content">
        ...
        <div className="row">
          <div className="col-md-12 animate-box" data-animate-effect="fadeInLeft">
            <p>Here are some of my skills I've accumaleted, listed with their relative proficiencies.</p>
          </div>
          <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
            <div className="progress-wrap">
              <h3>Java & C Programming</h3>
          ...
          <div className="col-md-6 animate-box" data-animate-effect="fadeInRight">
            <div className="progress-wrap">
              ...
              <div className="progress">
                <div className="progress-bar color-2" role="progressbar" aria-valuenow={50} aria-valuemin={0} aria-valuemax={100} style={{width: '55%'}}>
          ...
          <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
            <div className="progress-wrap">
              ...
              <div className="progress">
                <div className="progress-bar color-3" role="progressbar" aria-valuenow={50} aria-valuemin={0} aria-valuemax={100} style={{width: '69%'}}>
                  <span>Experience With</span>
                </div>
              </div>
            </div>
